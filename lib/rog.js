(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("rog", ["fetch-everywhere"], factory);
	else if(typeof exports === 'object')
		exports["rog"] = factory(require("fetch-everywhere"));
	else
		root["rog"] = factory(root["fetch-everywhere"]);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(116), __webpack_require__(85), __webpack_require__(86)))
...
var _me = __webpack_require__(301);
...
var CoolPerson = exports.CoolPerson = function () {
  function CoolPerson(props) {
    _classCallCheck(this, CoolPerson);

    this.props = {};
  }

  _createClass(CoolPerson, [{
    key: 'requestData',
    value: function () {
      var _ref = _asyncGenerator.wrap(regeneratorRuntime.mark(function _callee(url) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return _asyncGenerator.await(fetch(request.url, request.headers));

              case 3:
                response = _context.sent;
                _context.next = 6;
                return _asyncGenerator.await(response.json());
    ...
    key: 'githubActivity',
    value: function githubActivity() {
      var data = this.requestData('https://api.github.com/users/' + this.props.github + '/events').next();
      return data;
    }
  }]);
...
var Rog = function (_CoolPerson) {
  _inherits(Rog, _CoolPerson);

  function Rog() {
    _classCallCheck(this, Rog);

    var _this = _possibleConstructorReturn(this, (Rog.__proto__ || Object.getPrototypeOf(Rog)).call(this));

    _this.props = _me2.default;
    return _this;
  }
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(86), __webpack_require__(85), __webpack_require__(116)))
